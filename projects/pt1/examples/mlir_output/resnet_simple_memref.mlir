// Auto-generated by resnet_simple_to_linalg.py (torch-mlir). emit=memref-stack-weights. Not bit-identical to tests/riscv_tests/resnet_simple.mlir.
// Hand-tuned (defaults = RVV tests/riscv_tests/resnet_simple_memref.mlir): input 1x3x5x5, padded 11x11, conv 9x9, pool 9x9 / 81; logits 1x4 (FC 4x4 + bias 4).
...
module attributes {torch.debug_module_name = "ResNetSimple"} {
  func.func @forward(%arg0: memref<1x3x5x5xf32, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x4xf32> {
    ...
    linalg.matmul ins(%collapse_shape, %alloc_7 : memref<1x4xf32>, memref<4x4xf32>) outs(%alloc_18 : memref<1x4xf32>)
