...
module attributes {torch.debug_module_name = "MnistNet"} {
  memref.global "private" constant @__constant_10x32xf32 : memref<10x32xf32> = dense_resource<__elided__> {alignment = 64 : i64}
  memref.global "private" constant @__constant_10xf32 : memref<10xf32> = dense<[0.109545261, 0.150168076, 0.00724894181, -0.0129423486, 0.103974313, -0.153303191, 0.0109279193, 0.115677841, 0.12233936, 0.0208303425]> {alignment = 64 : i64}
  memref.global "private" constant @__constant_32x196xf32 : memref<32x196xf32> = dense_resource<__elided__> {alignment = 64 : i64}
  memref.global "private" constant @__constant_32xf32 : memref<32xf32> = dense_resource<__elided__> {alignment = 64 : i64}
  func.func @forward(%arg0: memref<1x1x28x28xf32, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x10xf32> {
    ...
    %1 = memref.get_global @__constant_32x196xf32 : memref<32x196xf32>
    %2 = memref.get_global @__constant_10xf32 : memref<10xf32>
    %3 = memref.get_global @__constant_10x32xf32 : memref<10x32xf32>
