...
void *forward(void *input_arg0) {
  ...
  // Tensor arg0: shape (batch=32, M=32, K=1)
  ...
  Tensor tensor_arg0 = (Tensor){
    ...
    .byte_stride2 = min_stride_arg0 * 32,
    .wd_data      = WIDTH_8,
    .type_data    = TYPE_FP
  };

  // Tensor alloc: shape (batch=1, M=32, K=1)
  ...
  Tensor tensor_alloc = (Tensor){
    ...
    .byte_stride2 = min_stride_alloc * 32,
    .wd_data      = WIDTH_8,
    .type_data    = TYPE_FP
  };
  ...
  reduce_dim2_sum(&tensor_arg0, &tensor_alloc);
