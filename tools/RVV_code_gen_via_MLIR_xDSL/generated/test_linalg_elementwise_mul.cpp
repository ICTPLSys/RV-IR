...
// ====================================================================
// Generated function: test_elementwise_mul
// ====================================================================

void test_elementwise_mul(void) {
  ...
  make_tensor(&tensor_arg0, BASE_SCRATCHPAD3, 2048, 128, 1, td, wd);
  make_tensor(&tensor_arg1, BASE_SCRATCHPAD3, 2048, 128, 1, td, wd);
  make_tensor(&tensor_alloc, BASE_SCRATCHPAD0, 2048, 128, 1, td, wd);
  ...
  tensor_tensor_operator(&tensor_arg0, &tensor_arg1, &tensor_alloc, OPERATION_MUL);
