"builtin.module"() ({
  "func.func"() <{sym_name = "test_exp_4d", function_type = (!emitc.ptr<f32>) -> !emitc.ptr<f32>}> ({
  ^bb0(%arg0 : !emitc.ptr<f32>):
    ...
    %1 = "emitc.call_opaque"(%arg0, %alloc) <{callee = "lut_exp", args = ["Tensor*", "Tensor*"]}> : (!emitc.ptr<f32>, memref<1x32x128x128xf32>) -> memref<1x32x128x128xf32>
