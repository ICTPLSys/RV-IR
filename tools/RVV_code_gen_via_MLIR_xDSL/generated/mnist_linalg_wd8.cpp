...
void forward(void) {
  ...
  make_tensor(&tensor_4, BASE_SCRATCHPAD0 + 0x160u, 196, 32, 1, td, wd);
  make_tensor(&tensor_8, BASE_SCRATCHPAD0 + 0x1D60u, 10, 1, 1, td, wd);
  make_tensor(&tensor_alloc, BASE_SCRATCHPAD0 + 0x1D80u, 14, 14, 1, td, wd);
  make_tensor(&tensor_alloc_1, BASE_SCRATCHPAD0 + 0x1F40u, 2, 2, 1, td, wd);
  make_tensor(&tensor_alloc_10, BASE_SCRATCHPAD0 + 0x1F80u, 10, 1, 1, td, wd);
  make_tensor(&tensor_alloc_11, BASE_SCRATCHPAD0 + 0x1FA0u, 10, 1, 1, td, wd);
  make_tensor(&tensor_alloc_11__reduce_dim0_in, BASE_SCRATCHPAD2 + 0x0u, 10, 1, 1, td, wd);
  make_tensor(&tensor_alloc_12, BASE_SCRATCHPAD0 + 0x1FE0u, 1, 1, 1, td, wd);
  make_tensor(&tensor_alloc_13, BASE_SCRATCHPAD0 + 0x2000u, 1, 1, 1, td, wd);
  make_tensor(&tensor_alloc_14, BASE_SCRATCHPAD2 + 0x20u, 1, 1, 1, td, wd);
  make_tensor(&tensor_alloc_15, BASE_SCRATCHPAD0 + 0x2040u, 1, 1, 1, td, wd);
  make_tensor(&tensor_alloc_16, BASE_SCRATCHPAD0 + 0x2060u, 10, 1, 1, td, wd);
  make_tensor(&tensor_alloc_17, BASE_SCRATCHPAD0 + 0x2080u, 10, 1, 1, td, wd);
  make_tensor(&tensor_alloc_18, BASE_SCRATCHPAD0 + 0x20A0u, 1, 1, 1, td, wd);
  make_tensor(&tensor_alloc_19, BASE_SCRATCHPAD2 + 0x40u, 1, 1, 1, td, wd);
  make_tensor(&tensor_alloc_2, BASE_SCRATCHPAD0 + 0x20E0u, 14, 14, 1, td, wd);
  make_tensor(&tensor_alloc_20, BASE_SCRATCHPAD0 + 0x22A0u, 10, 1, 1, td, wd);
  make_tensor(&tensor_alloc_3, BASE_CIM0, 32, 196, 1, td, wd);
  make_tensor(&tensor_alloc_4, BASE_SCRATCHPAD0 + 0x22C0u, 32, 1, 1, td, wd);
  make_tensor(&tensor_alloc_5, BASE_SCRATCHPAD0 + 0x22E0u, 32, 1, 1, td, wd);
  make_tensor(&tensor_alloc_6, BASE_SCRATCHPAD0 + 0x2300u, 32, 1, 1, td, wd);
  make_tensor(&tensor_alloc_7, BASE_SCRATCHPAD0 + 0x2320u, 32, 1, 1, td, wd);
  make_tensor(&tensor_alloc_8, BASE_CIM_FC, 10, 32, 1, td, wd);
  make_tensor(&tensor_alloc_9, BASE_SCRATCHPAD0 + 0x2340u, 10, 1, 1, td, wd);
  make_tensor(&tensor_collapse_shape, BASE_SCRATCHPAD0 + 0x20E0u, 196, 1, 1, td, wd);
  make_tensor(&tensor_expand_shape, BASE_SCRATCHPAD0 + 0x2360u, 10, 1, 1, td, wd);
