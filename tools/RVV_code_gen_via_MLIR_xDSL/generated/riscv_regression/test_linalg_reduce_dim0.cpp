...
// ====================================================================
// Generated function: test_reduce_dim0_sum
// ====================================================================

void *test_reduce_dim0_sum(void *input_arg0) {
  ...
  // Tensor arg0: shape (batch=2048, M=128, K=128)
  int min_stride_arg0 = min_stride1(128, WIDTH_8);
  ...
  reduce_dim0_sum(&tensor_arg0, &tensor_alloc);
