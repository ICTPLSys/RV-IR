...
module attributes {torch.debug_module_name = "ResNetSimple"} {
  func.func @forward(%arg0: memref<1x3x4x4xf32>) -> memref<1x2xf32> {
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc : memref<1x3x10x10xf32>)
    ...
    linalg.generic {indexing_maps = [#map, #map1, #map1, #map1, #map1, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%conv_wrk, %bn_gamma, %bn_beta, %bn_mean, %bn_var : memref<1x4x8x8xf32>, memref<4xf32>, memref<4xf32>, memref<4xf32>, memref<4xf32>) outs(%bn_out : memref<1x4x8x8xf32>) {
