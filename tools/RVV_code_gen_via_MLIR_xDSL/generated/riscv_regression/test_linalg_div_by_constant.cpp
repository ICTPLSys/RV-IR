...
// ====================================================================
// Generated function: test_div_by_constant
// ====================================================================

void *test_div_by_constant(void *input_arg0) {
  ...
  // Tensor arg0: shape (batch=1, M=128, K=1)
  ...
  tensor_imm_operator(&tensor_arg0, &tensor_alloc, 5.000000e, WIDTH_8, TYPE_FP, OPERATION_DIV);
