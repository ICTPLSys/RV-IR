// Fallback path: original MLIR kept due named-op parser limitations.
...
module attributes {torch.debug_module_name = "ResNet"} {
  ...
  func.func @forward(%arg0: memref<1x3x224x224xf32, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x1000xf32> {
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc : memref<1x3x230x230xf32>)
    ...
    linalg.fill ins(%cst_1 : f32) outs(%alloc_7 : memref<1x64x114x114xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_12 : memref<1x64x58x58xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_18 : memref<1x64x58x58xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_24 : memref<1x64x58x58xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_29 : memref<1x64x58x58xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_35 : memref<1x64x58x58xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_41 : memref<1x128x30x30xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_49 : memref<1x128x30x30xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_54 : memref<1x128x30x30xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_60 : memref<1x128x30x30xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_66 : memref<1x256x16x16xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_74 : memref<1x256x16x16xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_79 : memref<1x256x16x16xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_85 : memref<1x256x16x16xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_91 : memref<1x512x9x9xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_99 : memref<1x512x9x9xf32>)
    ...
    linalg.fill ins(%cst_2 : f32) outs(%alloc_104 : memref<1x512x9x9xf32>)
