"builtin.module"() ({
  ...
  ^bb0(%arg0 : !emitc.ptr<f32>):
    ...
    %2 = "emitc.call_opaque"(%0, %alloc) <{callee = "broadcast_operator", args = ["Tensor*", "Tensor*"]}> : (memref<512x2048xf32>, memref<1x2048x512xf32>) -> memref<1x2048x512xf32>
    %alloc_1 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<1x128x512xf32>
    %3 = "builtin.unrealized_conversion_cast"(%alloc_1) : (memref<1x128x512xf32>) -> !emitc.ptr<f32>
    ...
    %5 = "emitc_ext.constant"() {value = 128 : index} : () -> index
    %6 = "emitc_ext.constant"() {value = 512 : index} : () -> index
    %7 = "emitc_ext.constant"() {value = 2048 : index} : () -> index
