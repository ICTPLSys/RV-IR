"builtin.module"() ({
  "func.func"() <{sym_name = "test_exp", function_type = (!emitc.ptr<f32>) -> !emitc.ptr<f32>}> ({
  ^bb0(%arg0 : !emitc.ptr<f32>):
    ...
    %1 = "emitc.call_opaque"(%arg0, %alloc) <{callee = "lut_exp", args = ["Tensor*", "Tensor*"]}> : (!emitc.ptr<f32>, memref<1x128x2048xf32>) -> memref<1x128x2048xf32>
