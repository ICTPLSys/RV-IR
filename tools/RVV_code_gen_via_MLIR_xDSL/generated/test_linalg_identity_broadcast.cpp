...
void test_identity_broadcast(void) {
  ...
  make_tensor(&tensor_arg0, BASE_SCRATCHPAD3, 8192, 2048, 1, td, wd);
  make_tensor(&tensor_alloc, BASE_SCRATCHPAD0, 8192, 2048, 1, td, wd);
  ...
  // Broadcast/copy tensor data (memcpy fallback)
