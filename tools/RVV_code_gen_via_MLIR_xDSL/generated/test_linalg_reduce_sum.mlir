"builtin.module"() ({
  "func.func"() <{sym_name = "test_reduce_sum_last_dim", function_type = (!emitc.ptr<f32>) -> !emitc.ptr<f32>}> ({
  ^bb0(%arg0 : !emitc.ptr<f32>):
    ...
    %1 = "emitc.call_opaque"(%arg0, %alloc) <{callee = "reduce_dim0_sum", args = ["Tensor*", "Tensor*"]}> : (!emitc.ptr<f32>, memref<1x128x1xf32>) -> memref<1x128x1xf32>
