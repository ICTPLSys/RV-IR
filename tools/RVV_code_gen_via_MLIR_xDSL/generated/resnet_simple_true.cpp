...
void forward(void) {
  ...
  make_tensor(&tensor_arg0, BASE_SCRATCHPAD3, 3, 4, 4, td, wd);
  make_tensor(&tensor_alloc, BASE_SCRATCHPAD0, 3, 10, 10, td, wd);
  make_tensor(&tensor_bn_beta, BASE_SCRATCHPAD3, 4, 1, 1, td, wd);
  make_tensor(&tensor_bn_gamma, BASE_SCRATCHPAD3, 4, 1, 1, td, wd);
  make_tensor(&tensor_bn_mean, BASE_SCRATCHPAD3, 4, 1, 1, td, wd);
  make_tensor(&tensor_bn_out, BASE_SCRATCHPAD0, 4, 8, 8, td, wd);
  make_tensor(&tensor_bn_var, BASE_SCRATCHPAD3, 4, 1, 1, td, wd);
  make_tensor(&tensor_collapsed, BASE_SCRATCHPAD0, 4, 1, 1, td, wd);
  make_tensor(&tensor_conv_wrk, BASE_SCRATCHPAD1, 4, 8, 8, td, wd);
  make_tensor(&tensor_fc_b, BASE_SCRATCHPAD3, 2, 1, 1, td, wd);
  make_tensor(&tensor_fc_w, BASE_SCRATCHPAD2, 2, 4, 1, td, wd);
  make_tensor(&tensor_fc_w_t, BASE_CIM_FC, 4, 2, 1, td, wd);
  make_tensor(&tensor_in, BASE_SCRATCHPAD3, 3, 4, 4, td, wd);
  make_tensor(&tensor_logits, BASE_SCRATCHPAD0, 2, 1, 1, td, wd);
  make_tensor(&tensor_out, BASE_SCRATCHPAD1, 2, 1, 1, td, wd);
  make_tensor(&tensor_pool_k, BASE_SCRATCHPAD2, 8, 8, 1, td, wd);
  make_tensor(&tensor_pooled_avg, BASE_SCRATCHPAD0, 4, 1, 1, td, wd);
  make_tensor(&tensor_pooled_wrk, BASE_SCRATCHPAD3, 4, 1, 1, td, wd);
  make_tensor(&tensor_relu_out, BASE_SCRATCHPAD1, 4, 8, 8, td, wd);
  ...
  flatten_operator(&tensor_pooled_avg);
