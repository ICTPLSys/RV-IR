...
// ====================================================================
// Generated function: test_exp_4d
// ====================================================================

void test_exp_4d(void) {
  ...
  make_tensor(&tensor_arg0, BASE_SCRATCHPAD3, 128, 128, 32, td, wd);
  make_tensor(&tensor_alloc, BASE_SCRATCHPAD0, 128, 128, 32, td, wd);
  ...
  for (int batch = 0; batch < 1; batch++) {
    ...
    Tensor tensor_arg0_3d;
    make_tensor(&tensor_arg0_3d, tensor_arg0.base_addr + (uint32_t)batch * (32 * 128 * 128 * 4u), 32, 128, 128, TYPE_INT, WIDTH_8);
    Tensor tensor_alloc_3d;
    make_tensor(&tensor_alloc_3d, tensor_alloc.base_addr + (uint32_t)batch * (32 * 128 * 128 * 4u), 32, 128, 128, TYPE_INT, WIDTH_8);
