// Test case: Reduce Max operation (arith.maximumf with reduction iterator)
// Corresponds to: reduce_dim0_max(&tensor_in, &tensor_out) under _npu_view_dims

#map = affine_map<(d0, d1, d2) -> (d0, d1, d2)>
#map1 = affine_map<(d0, d1, d2) -> (d0, d1)>

module {
  func.func @test_reduce_max(%arg0: memref<1x128x2048xf32>) -> memref<1x128x1xf32> {
