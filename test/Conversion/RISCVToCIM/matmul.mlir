...
module attributes {torch.debug_module_name = "Linear"} {
  ...
  func.func @main(%arg0: memref<16x32xi64, strided<[?, ?], offset: ?>>) -> memref<16x64xi64> {
    ...
    rair.transpose ins(%0 : memref<64x32xi64>) outs(%alloc : memref<32x64xi64>) {permutation = array<i64: 1, 0>}
    ...
    rair.matmul ins(%arg0, %alloc : memref<16x32xi64, strided<[?, ?], offset: ?>>, memref<32x64xi64>) outs(%alloc_1 : memref<16x64xi64>)
