...
module attributes {torch.debug_module_name = "Linear"} {
  ...
  func.func @forward(%arg0: memref<1x4x8xf32>) -> memref<1x4x16xf32> {
    ...
    riscv.transpose ins(%0 : memref<16x8xf32>) outs(%alloc : memref<8x16xf32>) {permutation = array<i64: 1, 0>}
    ...
    riscv.batch_matmul ins(%arg0, %alloc_0 : memref<1x4x8xf32>, memref<1x8x16xf32>) outs(%alloc_1 : memref<1x4x16xf32>)
