...
module attributes {torch.debug_module_name = "PoolingNCHWMax"} {
  ...
  memref.global "private" constant @__constant_3x3xf32: memref<3x3xf32> = dense<0.0> {alignment = 64 : i64}
  ...
  func.func @main(
    ...
    riscv.pooling_nchw_max {dilations = dense<[1, 1]> : vector<2xi64>, strides = dense<[2, 2]> : vector<2xi64>}
