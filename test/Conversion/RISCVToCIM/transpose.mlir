...
module attributes {torch.debug_module_name = "Linear"} {
  ...
  func.func @main(%arg0: memref<1x128x2048xf32, strided<[?, ?, ?], offset: ?>>) -> memref<1x128x512xf32> {
    ...
    riscv.transpose ins(%0 : memref<512x2048xf32>) outs(%alloc : memref<2048x512xf32>) {permutation = array<i64: 1, 0>}
    ...
    // riscv.batch_matmul ins(%arg0, %alloc_0 : memref<1x128x2048xf32, strided<[?, ?, ?], offset: ?>>, memref<1x2048x512xf32>) outs(%alloc_2 : memref<1x128x512xf32>)
