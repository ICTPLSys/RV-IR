...
// This test protects the active pre-Core compatibility operations during the
// staged migration. In-place compute, copies, and observable I/O must not be
// removed as dead pure operations.
